...
export default function AITalkScreen({ navigation, route }) {
  ...
  const [isMessageComplete, setIsMessageComplete] = useState(true); // 바로 완료 상태로 설정
        ...
        {!isMessageComplete ? (
          ...
          <View style={styles.actionButtonsContainer}>
            <TouchableOpacity style={styles.answerButton} onPress={handleAnswer}>
              <Text style={styles.answerButtonText}>이어가기</Text>
            </TouchableOpacity>
